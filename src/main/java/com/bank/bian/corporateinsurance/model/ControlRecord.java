package com.bank.bian.corporateinsurance.model;
...
/**
 * The BIAN control record for this service domain: "Insurance Policy Administrative Plan".
 *
 ...
 * to its asset type (Insurance Policy). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Insurance Policy Administrative Plan";
